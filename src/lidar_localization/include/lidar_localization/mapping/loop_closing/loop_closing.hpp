...
#include "lidar_localization/mapping/loop_closing/KDTreeVectorOfVectorsAdaptor.h"
#include "lidar_localization/mapping/loop_closing/nanoflann.hpp"
    /*20201029DFJ add*/
...
class LoopClosing {
  ...
  private:
    ...
    bool SC_JointMap(int key_frame_index, CloudData::CLOUD_PTR& map_cloud_ptr, Eigen::Matrix4f& map_pose);
    bool SC_JointScan(CloudData::CLOUD_PTR& scan_cloud_ptr, Eigen::Matrix4f& scan_pose);
